package io.wjh.wcartadministrationback.constant;
...
public class ClientExceptionConstant {
    ...
    public static final String ADMINISTRATOR_USERNAME_ALREADY_EXIST_ERRCODE = "0109";
    public static final String ADMINISTRATOR_USERNAME_ALREADY_EXIST_ERRMSG = "administrator username already exist";

    public static final String ADMINISTRATOR_EMAIL_ALREADY_EXIST_ERRCODE = "0110";
    public static final String ADMINISTRATOR_EMAIL_ALREADY_EXIST_ERRMSG = "administrator username already exist";
