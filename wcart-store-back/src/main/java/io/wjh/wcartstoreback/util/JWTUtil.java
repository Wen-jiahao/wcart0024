package io.wjh.wcartstoreback.util;
...
import io.wjh.wcartstoreback.po.Administrator;
import io.wjh.wcartstoreback.po.Customer;
import io.wjh.wcartstoreback.vo.AdministratorLoginVO;
...
public class JWTUtil {
    ...
    public AdministratorLoginVO verifyToken(String token) {
        ...
        administratorLoginVO.setCustomerId(jwt.getClaim("customerId").asInt());
